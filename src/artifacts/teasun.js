...
class CaffeineRage {
  ...
  update() {
    ...
    document.getElementById("sky-canvas").style.filter = "brightness(120%)";
    document.getElementById("mountains-canvas").style.filter = "brightness(120%)";
    document.getElementById("background-mountains-canvas").style.filter = "brightness(120%)";
    document.getElementById("fuji-canvas").style.filter = "brightness(120%)";
    document.getElementById("cloud-layer-c-canvas").style.filter = "brightness(121%)";
